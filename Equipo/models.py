...
class Equipo(models.Model):
    ...
    ST_IMG_EQUIPO = models.FileField(upload_to='img_equipo/', null=False, blank=False, default='img_equipo/default.png', validators=[FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png'])], verbose_name="Imagen del equipo")
